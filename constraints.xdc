...
set_property PACKAGE_PIN T17 [get_ports submit]						
...
set_property PACKAGE_PIN U16 [get_ports current_key[0]]
set_property PACKAGE_PIN E19 [get_ports current_key[1]]
set_property PACKAGE_PIN U19 [get_ports current_key[2]]
set_property PACKAGE_PIN V19 [get_ports current_key[3]]

set_property IOSTANDARD LVCMOS33 [get_ports {led[0] led[1] led[2] led[3] led[4] led[5] led[6] led[7] current_key[0] current_key[1] current_key[2] current_key[3]}]
